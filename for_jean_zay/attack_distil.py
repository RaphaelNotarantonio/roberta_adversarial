...
def main(): 
    ...
    model = DistilBertForSequenceClassification.from_pretrained(
        "./my_pretrained_distil", # Use the 12-layer BERT model, with an uncased vocab.  #please rather use "distilbert-base-cased"
    ...
    #load saved model (which is finetuned distilbert)
    model.load_state_dict(torch.load('./distil_finetuned.pt', map_location=map_location))
    model.eval()
