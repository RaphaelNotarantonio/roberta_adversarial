...
#here we attack sentences by specifying the words of the sentence we attack (see l1 and l2 below)
...
def main():  
  # attack algorithm settings
    ...
    # l1: index of the sentence we attack
    # l2: indexes of the words of the sentence we attack
